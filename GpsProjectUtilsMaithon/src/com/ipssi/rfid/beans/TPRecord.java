...
public class TPRecord {
	...
	/*
	 * @Column("create_status") private int createStatus = Misc.getUndefInt();
	 */
	@Column("mark_for_gps")
	...
	private double invoiceValue = Misc.getUndefDouble();
	...
	@Column("random_qc_check")
	private int randomQcCheck = Misc.getUndefInt();

	public int getRandomQcCheck() {
		return randomQcCheck;
	}

	public void setRandomQcCheck(int randomQcCheck) {
		this.randomQcCheck = randomQcCheck;
	}
	...
	public String toString() {
		...
		retval.append("LatestUnloadGateInExit:" + getLatestUnloadGateInExit())
				.append("\n");
		retval.append("LatestUnloadWbInExit:" + getLatestUnloadWbInExit())
				.append("\n");
		retval.append("LatestUnloadYardInExit:" + getLatestUnloadYardInExit())
				.append("\n");
		retval
				.append(
						"LatestUnloadYardOutExit:"
								+ getLatestUnloadYardOutExit()).append("\n");
		retval.append("LatestUnloadWbOutExit:" + getLatestUnloadWbOutExit())
				.append("\n");
		retval
				.append(
						"LatestUnloadGateOutExit:"
								+ getLatestUnloadGateOutExit()).append("\n");
		...
		retval.append("PrevStepType:" + getPreStepType()).append("\n");
		retval.append("NextStepType:" + getNextStepType()).append("\n");
	...
	public boolean isEquals(int vehicleId, int doId, int minesId,
			int materialGradeId, int transporterId, String challanNo,
			String lrNo, Date challanDate, Date lrDate, double loadTare,
			double loadGross) {
		return vehicleId == this.vehicleId
				...
				&& ((challanDate == null ? Misc.getUndefInt() : challanDate
						.getTime()) == (this.challanDate == null ? Misc
						.getUndefInt() : this.challanDate.getTime()))
				&& ((lrDate == null ? Misc.getUndefInt() : lrDate.getTime()) == (this.lrDate == null ? Misc
						.getUndefInt()
						: this.lrDate.getTime()))
	...
	public boolean isEquals(TPRecord tpRecord) {
		return isEquals(tpRecord.getVehicleId(), tpRecord.getDoId(), tpRecord
				.getMinesId(), tpRecord.getMaterialGradeId(), tpRecord
				.getTransporterId(), tpRecord.getChallanNo(), tpRecord
				.getLrNo(), tpRecord.getChallanDate(), tpRecord.getLrDate(),
				tpRecord.getLoadTare(), tpRecord.getLoadGross());
	}
	...
	public long getWorkStationTime(int workStationType) {
		...
		return lastPrcoessed != null ? lastPrcoessed.getTime() : Misc
				.getUndefInt();
	}
	...
	public long getLastProcessedTime() {
		 ...
		 * else if(tprCreateDate != null){ lastProcessedDate = tprCreateDate; }
		 */else if (challanDate != null) {
			lastProcessedDate = challanDate;
		}
		return lastProcessedDate != null ? lastProcessedDate.getTime() : Misc
				.getUndefInt();
	}

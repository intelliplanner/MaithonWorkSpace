...
public class CoalWeighBridgeOutWindow extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel2Layout.setHorizontalGroup(
				...
				.addGroup(jPanel2Layout.createSequentialGroup()
						...
						.addGap(31, 31, 31)
						.addComponent(tprIdLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(78, 78, 78)
		...
		jPanel2Layout.setVerticalGroup(
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(tprIdLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(jPanel2Layout.createSequentialGroup()		
										.addContainerGap()
										.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
		...
		qcDone.addItem(new ComboItem(1, "QC-GPS Done"));
		qcDone.addItem(new ComboItem(2, "QC-Random Done"));
		qcDone.addItem(new ComboItem(3, "Not done"));
		//		qcDone.addItem(new ComboItem(0, "Select"));
	...
	private void quickCreateAndOpen() {
		...
		try{
			...
			if(isRequestOverride){
				...
				double captureWeight = Misc.getUndefDouble();
	...
	private int InsertTPRStep(Connection conn,boolean isDeny,boolean repeatProcess) throws Exception {
		if (tpStep == null || Misc.isUndef(tpStep.getId())) {
			...
			//tpStep.setCoalWbOutGpsLocation(GateInDao.removeSpecialChar(gpsLocation.getText()));
	...
	private void requestOverrideAction() {
		...
		try {
			conn = DBConnectionPool.getConnectionFromPoolNonWeb();
			updateTPR(conn,Misc.getUndefDouble(), true);

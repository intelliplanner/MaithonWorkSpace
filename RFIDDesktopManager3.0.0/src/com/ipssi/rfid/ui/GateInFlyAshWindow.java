...
//	static {
//	    System.loadLibrary("FingerprintSensorAPI.dll");
//	  }
//	
	...
	private void initComponents() {
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
			...
			.addGap(30,30,30)
			.addComponent(tprIdLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGap(26, 26, 26)
					...
					try {
						...
						if (true) {
							...
							System.out.println("IsVehicleExist: "+ GateInDao.getValue(isVehicleExist)+ " isFingerCaptured: "+ ""
									+ GateInDao.getValue(isFingerCaptured)+ " isFingerVerified: "+ GateInDao.getValue(isFingerVerified)
									+ " isChallanExist"+ " "+ GateInDao.getValue(!Utils.isNull(tprRecord.getChallanNo()))
									+ " isTpRecordValid: " + ""+ GateInDao.getValue(isTpRecordValid)
									+ " isTagRead: "+ GateInDao.getValue(isTagRead));
						...
						if(repeatProcess){
							...
							JOptionPane.showMessageDialog(null,"Go to "+ com.ipssi.rfid.constant.Type.WorkStationType.getString(nextWorkstationType));
						}
					} catch (Exception ex) {

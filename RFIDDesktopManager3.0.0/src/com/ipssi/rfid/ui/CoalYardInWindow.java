...
//        gpsTime.setText("asdfghjkl;wertyuiod");
	...
	private void setHiddenField(boolean isTrue) {
		// TODO Auto-generated method stub
		changeIIAInformed(isTrue);
		changeGPSFixedPanel(isTrue);
		bedAssigned.setEnabled(isTrue);
		bedAssigned.setForeground(Color.WHITE);
	}
...
//						changeIIAInformed(true);
					...
					randomQC.setText(tprRecord.getRandomQcCheck() == 1 ? "YES" : "NO");
	...
	private void initComponents() {
        ...
        jLabel14.setText("Random QC:");
        randomQC = new javax.swing.JLabel();
//        randomQC.setText("Yes");
...
//	    tprIdLabel.setText("TPR-ID:1234567890");
		...
		jPanel2Layout.setVerticalGroup(
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(button1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE))
                .addContainerGap())
		...
		blocking_reason.setMinimumSize(null);
		 ...
		 randomQC.setFont(ApplicationConstant.textFont);
		 randomQC.setForeground(UIConstant.textFontColor);
												...
												.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addGroup(jPanel1Layout.createSequentialGroup()
																...
																.addGroup(jPanel1Layout.createSequentialGroup()
										                                ...
										                                .addGroup(jPanel1Layout.createSequentialGroup()
										                                        .addComponent(randomQC, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										                                        .addGap(90, 90, 90)))))
										                                .addGap(0, 0, Short.MAX_VALUE)))
										                .addContainerGap())
										            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private javax.swing.JLabel randomQC;
	...
	private int InsertTPRStep(Connection conn,boolean isDeny, boolean repeatProcess) throws Exception {
		...
		if (tpStep == null || Misc.isUndef(tpStep.getId())) {
			...
			//tpStep.setCoalYardInGpsLocation(GateInDao.removeSpecialChar(gpsLocation.getText()));
	...
	private void quickCreateAndOpen() {
		...
		try{
			...
			if (tprRecord == null) {
				...
				if(tpr != null && TPRInformation.isGreaterThanEqualsProcessed(tpr, TokenManager.currWorkStationType, TokenManager.materialCat)){
					repeatProcess = true;
					tprRecord = tpr;
				}else{
					repeatProcess = false;
				...
				if (true) {
					...
					if(TokenManager.isAutoSave && !vehicleBlackListed){

    ...
    public RFIDTagInfo createTag(int readerId)
    {
        ...
        if (vehicleName != null)
        {
            ...
            if (vehicleName != null && vehicleName.length() > 0)
            {
                ...
                tagInfo.tagId = null;
                binary.append(Utils.EncodingSpecialToBinary("@"));//2
                ...
                binary.append(Utils.Encoding6StringToBinary(Utils.getStdString(challanId,12)));//72
                ...
                binary.append(Utils.EncodingIntToBinary((loadTare > 0 ? (loadTare/10) : loadTare), 13));//13
                binary.append(Utils.EncodingIntToBinary((loadGross > 0 ? (loadGross/10) : loadGross), 13));//13
                binary.append(Utils.EncodingIntToBinary(preMinesId, 6));//6
                binary.append(Utils.EncodingIntToBinary(preDeviceId, 6));//6
                binary.append(Utils.EncodingIntToBinary(preRecordId, 32));//32
                binary.append(Utils.Encoding6StringToBinary(Utils.getStdString(preChallanId,12)));//72

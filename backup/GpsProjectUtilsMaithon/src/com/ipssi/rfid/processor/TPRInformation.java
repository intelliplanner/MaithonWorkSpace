...
public class TPRInformation {
	...
	private static final int sameStationTprThreshold = 150*60*1000;
...
//		try {
	...
	private static boolean isSameWorkStation(TPRecord tpr, int workStationType){
	...
	private static boolean isGreaterThanEqualsProcessed(TPRecord tpr, int workStationType, int materialCat){
